...
int main()
{
    ...
    std::cout << "====" << std::endl;
    {
        ...
        a.add('a', "",       "", "Describe A", dummy_handler, true);
        a.add('a', "",       "", "Describe A", dummy_handler, "AA");
        a.add({},  "long-a", "", "Describe A", dummy_handler, "");
        a.add({},  "long-a", "", "Describe A", dummy_handler, true);
...

    {
...

        {
            ...
            assert(!error);
            assert(args.size() == 2);
            assert(args[0].option == "c");
            assert(args[0].optarg == "C1");
            assert(args[1].option == "c");
            assert(args[1].optarg == "C2");
            args.clear();
            assert(argv.empty());
        }

        {
            ...
            assert(args[0].optarg == "C1");
            assert(args[1].option == "c");
            assert(args[1].optarg == "");
            assert(args[2].option == "c");
            assert(args[2].optarg == "C2");
            args.clear();
            assert(argv.size() == 1);
...

    {
        ...
        assert(args.size() == 5);
        assert(args[0].option == "a");
        assert(args[0].optarg == "");
        assert(args[1].option == "d");
        assert(args[1].optarg == "D");
        assert(args[2].option == "a");
        assert(args[2].optarg == "");
        assert(args[3].option == "d");
        assert(args[3].optarg == "D2");
        assert(args[4].option == "f");
        assert(args[4].optarg == "F");
        args.clear();
        assert(argv.empty());
    }
}
